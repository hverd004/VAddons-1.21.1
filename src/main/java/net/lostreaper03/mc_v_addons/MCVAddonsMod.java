package net.lostreaper03.mc_v_addons;
...
@Mod(MCVAddonsMod.MOD_ID)
public class MCVAddonsMod {
    // Define mod id in a common place for everything to reference
    public static final String MOD_ID = "mc_v_addons";
...
*/
    public MCVAddonsMod(FMLJavaModLoadingContext context) {
    ...
    private void addCreative(BuildCreativeModeTabContentsEvent event) {
        if (event.getTabKey() == CreativeModeTabs.INGREDIENTS){
            event.accept(ModItems.PHANTOM_GEM);}
