package net.lostreaper03.mc_v_addons.block;
...
public class ModBlocks {
    public static final DeferredRegister<Block> BLOCKS =
            DeferredRegister.create(ForgeRegistries.BLOCKS, MCVAddonsMod.MOD_ID);

    public static final RegistryObject<Block> PHANTOM_GEM_BLOCK = registerBlock("phantom_gem_block",
