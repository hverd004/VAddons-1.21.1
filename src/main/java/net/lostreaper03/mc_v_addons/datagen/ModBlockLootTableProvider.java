...
public class ModBlockLootTableProvider extends BlockLootSubProvider {
    ...
    protected void generate() {
        //drops block
        dropSelf(ModBlocks.PHANTOM_GEM_BLOCK.get());

        /*
        drops other
        this.add(ModBlocks.ore.get(), block -> Create[multiple]OreDrop(ore.get, item.get,[min,max]);
        */
    }

    protected LootTable.Builder createMultpleOreDrops(Block pBlock, Item item, float minDrop, float maxDrop) {
